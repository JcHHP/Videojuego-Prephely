...
public class ResponderPregunta3 : MonoBehaviour {
    ...
    public logicaVidaSubjefeLuw Subjefe;  // CAMBIAR
	...
	void Start (){
        ...
        activarPregunta = FindObjectOfType<ActivadorPregunta3>();

        SubjefeObj =GameObject.Find("Subjefe Pigman");
        Subjefe = SubjefeObj.GetComponent<logicaVidaSubjefeLuw>();  // CAMBIAR
